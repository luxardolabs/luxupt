#!/usr/bin/env python3
# luxarch:luxpm-stop-guard hook v2 - DO NOT edit this file - it is emitted by `luxarch --emit hooks`; re-emit to update.
...
def main() -> int:
    ...
    print(
        ...
        "Log them (luxpm_add_comment / luxpm_create_activity / luxpm_log_work, link them with "
        "luxpm_link_commit, or close the issue) before finishing — work that isn't in the "
        "tracker is invisible.",
        file=sys.stderr,
    )
    return 2
